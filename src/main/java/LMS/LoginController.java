 ...
 * The class is responsible for managing the visibility of different forms and validating user inputs.
 *
 * <p>
...
public class LoginController {
    ...
    void handleForgotPassword(Event event) {
        showAlert("Unavailable function!", "Please contact administrator for further help\nEmail: 23020086@vnu.edu.vn");
    }
